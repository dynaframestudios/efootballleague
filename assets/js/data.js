...
const RESULTS = [
     ...
     //Matchday 10
     { round: 10, home: "Spartanburg FC", away: "Dont Worry", homeScore: 0, awayScore: 3,forfeit: true },
     ...
     { round: 10, home: "Manyora", away: "Sabah FC ", homeScore: 0, awayScore: 0,forfeit: true },
     ...
     { round: 11, home: "STRZ", away: "Manyora", homeScore: 0, awayScore: 0,forfeit: true },
     { round: 11, home: "sfundo FC", away: "Intra FC", homeScore: 6, awayScore: 2 },
     { round: 11, home: "Sabah FC ", away: "Heathens United", homeScore: 3, awayScore: 0 },
     ...
     //Matchday 12
     { round: 12, home: "Busby Babes", away: "Dont Worry", homeScore: 0, awayScore: 3,forfeit: true },
     { round: 12, home: "Manyora", away: "ATTACKERS", homeScore: 3, awayScore: 0 },
     { round: 12, home: "Intra FC", away: "Spartanburg FC", homeScore: 0, awayScore: 0,forfeit: true },
     ...
     //Matchday 13
     { round: 13, home: "Dont Worry", away: "Manyora", homeScore: 0, awayScore: 0,forfeit: true },
     ...
     { round: 13, home: "Sabah FC ", away: "Madoda FC", homeScore: 0, awayScore: 3,forfeit: true },
     { round: 13, home: "Danger FC", away: "StreetwiseFC", homeScore: 2, awayScore: 3 },
     //Matchday 14
     { round: 14, home: "Intra FC", away: "Dont Worry", homeScore: 0, awayScore: 3,forfeit: true },
     { round: 14, home: "Heathens United", away: "Manyora", homeScore: 0, awayScore: 13 },
     ...
     { round: 14, home: "Danger FC", away: "Sabah FC ", homeScore: 3, awayScore: 0,forfeit: true },
     //Matchday 15
     ...
     { round: 15, home: "Spartanburg FC", away: "StreetwiseFC", homeScore: 0, awayScore: 10 },
     { round: 15, home: "STRZ", away: "Danger FC", homeScore: 4, awayScore: 5 },
     { round: 15, home: "sfundo FC", away: "Sabah FC ", homeScore: 3, awayScore: 3 },
     //Matchday 16
     { round: 16, home: "Notorious_bZ", away: "Heathens United", homeScore: 0, awayScore: 3,forfeit: true },
     { round: 16, home: "Muntu19", away: "Intra FC", homeScore: 0, awayScore: 3, forfeit: true },
     { round: 16, home: "Madoda FC", away: "Manyora", homeScore: 3, awayScore: 0,forfeit: true },
     ...
     { round: 16, home: "Sabah FC ", away: "Spartanburg FC", homeScore: 0, awayScore: 0,forfeit: true },
     { round: 16, home: "sfundo FC", away: "STRZ", homeScore: 3, awayScore: 0,forfeit: true },
     //Matchday 17
     { round: 17, home: "Dont Worry", away: "Notorious_bZ", homeScore: 3, awayScore: 0,forfeit: true },
     { round: 17, home: "Heathens United", away: "Madoda FC", homeScore: 1, awayScore: 5 },
     { round: 17, home: "Intra FC", away: "StreetwiseFC", homeScore: 0, awayScore: 0,forfeit: true },
     ...
     { round: 17, home: "ATTACKERS", away: "sfundo FC", homeScore: 4, awayScore: 3 },
     { round: 17, home: "Spartanburg FC", away: "STRZ", homeScore: 2, awayScore: 3 },
     //Matchday 18
     { round: 18, home: "Muntu19", away: "Dont Worry", homeScore: 0, awayScore: 3, forfeit: true },
     { round: 18, home: "Madoda FC", away: "Notorious_bZ", homeScore: 3, awayScore: 0,forfeit: true  },
     { round: 18, home: "Danger FC", away: "Heathens United", homeScore: 10, awayScore: 2 },
     { round: 18, home: "Sabah FC ", away: "Intra FC", homeScore: 0, awayScore: 0,forfeit: true },
     { round: 18, home: "sfundo FC", away: "Manyora", homeScore: 3, awayScore: 0,forfeit: true },
     ...
     //Matchday 19
     { round: 19, home: "Dont Worry", away: "Madoda FC", homeScore: 0, awayScore: 3,forfeit: true },
     { round: 19, home: "Muntu19", away: "StreetwiseFC", homeScore: 0, awayScore: 3, forfeit: true },
     { round: 19, home: "Notorious_bZ", away: "Danger FC", homeScore: 0, awayScore: 3,forfeit: true  },
     { round: 19, home: "Heathens United", away: "sfundo FC", homeScore: 6, awayScore: 8 },
     { round: 19, home: "Intra FC", away: "STRZ", homeScore: 0, awayScore: 0,forfeit: true },
     { round: 19, home: "Manyora", away: "Spartanburg FC", homeScore: 0, awayScore: 0,forfeit: true },
     { round: 19, home: "Busby Babes", away: "ATTACKERS", homeScore: 2, awayScore: 8 },
     //Matchday 20
     { round: 20, home: "StreetwiseFC", away: "Dont Worry", homeScore: 9, awayScore: 4 },
     ...
     { round: 20, home: "sfundo FC", away: "Notorious_bZ", homeScore: 3, awayScore: 0,forfeit: true  },
     { round: 20, home: "Spartanburg FC", away: "Heathens United", homeScore: 8, awayScore: 1 },
     { round: 20, home: "ATTACKERS", away: "Intra FC", homeScore: 3, awayScore: 2 },
     ...
     { round: 21, home: "StreetwiseFC", away: "Sabah FC ", homeScore: 0, awayScore: 0,forfeit: true },
     { round: 21, home: "Madoda FC", away: "sfundo FC", homeScore: 1, awayScore: 3 },
     { round: 21, home: "Muntu19", away: "STRZ", homeScore: 0, awayScore: 3, forfeit: true },
     { round: 21, home: "Notorious_bZ", away: "Spartanburg FC", homeScore: 0, awayScore: 3,forfeit: true  },
     { round: 21, home: "Heathens United", away: "Busby Babes", homeScore: 3, awayScore: 3 },
     { round: 21, home: "Intra FC", away: "Manyora", homeScore: 0, awayScore: 0,forfeit: true },
     //Matchday 22
     { round: 22, home: "Sabah FC ", away: "Dont Worry", homeScore: 0, awayScore: 3,forfeit: true },
     { round: 22, home: "sfundo FC", away: "Danger FC", homeScore: 7, awayScore: 3 },
     { round: 22, home: "STRZ", away: "StreetwiseFC", homeScore: 0, awayScore: 0,forfeit: true },
     ...
     { round: 22, home: "Busby Babes", away: "Notorious_bZ", homeScore: 3, awayScore: 0,forfeit: true  },
     ...
     { round: 23, home: "Sabah FC ", away: "STRZ", homeScore: 0, awayScore: 0,forfeit: true },
     { round: 23, home: "Danger FC", away: "Spartanburg FC", homeScore: 9, awayScore: 4 },
     { round: 23, home: "StreetwiseFC", away: "ATTACKERS", homeScore: 5, awayScore: 4 },
     { round: 23, home: "Madoda FC", away: "Busby Babes", homeScore: 3, awayScore: 0,forfeit: true },
     { round: 23, home: "Muntu19", away: "Manyora", homeScore: 0, awayScore: 3, forfeit: true },
     { round: 23, home: "Notorious_bZ", away: "Intra FC", homeScore: 0, awayScore: 3,forfeit: true  },
     //Matchday 24
     ...
     { round: 24, home: "Manyora", away: "StreetwiseFC", homeScore: 0, awayScore: 0,forfeit: true },
     { round: 24, home: "Intra FC", away: "Madoda FC", homeScore: 0, awayScore: 3,forfeit: true },
     { round: 24, home: "Heathens United", away: "Muntu19", homeScore: 3, awayScore: 0, forfeit: true },
     //Matchday 25
     { round: 25, home: "Dont Worry", away: "Spartanburg FC", homeScore: 3, awayScore: 0,forfeit: true },
     ...
     { round: 25, home: "Sabah FC ", away: "Manyora", homeScore: 0, awayScore: 0,forfeit: true },
     ...
     { round: 26, home: "Manyora", away: "STRZ", homeScore: 0, awayScore: 0,forfeit: true },
     { round: 26, home: "Intra FC", away: "sfundo FC", homeScore: 2, awayScore: 5 },
     { round: 26, home: "Heathens United", away: "Sabah FC ", homeScore: 3, awayScore: 0,forfeit: true },
     { round: 26, home: "Notorious_bZ", away: "StreetwiseFC", homeScore: 0, awayScore: 3,forfeit: true  },
     ...
     //Matchday 28
     { round: 28, home: "Manyora", away: "Dont Worry", homeScore: 0, awayScore: 0,forfeit: true },
     ...
     { round: 28, home: "Notorious_bZ", away: "STRZ", homeScore: 0, awayScore: 3,forfeit: true  },
     { round: 28, home: "Muntu19", away: "sfundo FC", homeScore: 0, awayScore: 3, forfeit: true },
     { round: 28, home: "Madoda FC", away: "Sabah FC ", homeScore: 0, awayScore: 0,forfeit: true },
     { round: 28, home: "StreetwiseFC", away: "Danger FC", homeScore: 5, awayScore: 3 },
     //Matchday 29
     { round: 29, home: "Dont Worry", away: "Intra FC", homeScore: 3, awayScore: 0,forfeit: true },
     { round: 29, home: "Manyora", away: "Heathens United", homeScore: 7, awayScore: 1 },
     { round: 29, home: "ATTACKERS", away: "Notorious_bZ", homeScore: 3, awayScore: 0,forfeit: true  },
     { round: 29, home: "Spartanburg FC", away: "Muntu19", homeScore: 3, awayScore: 0, forfeit: true },
     { round: 29, home: "STRZ", away: "Madoda FC", homeScore: 0, awayScore: 0,forfeit: true },
     { round: 29, home: "sfundo FC", away: "StreetwiseFC", homeScore: 4, awayScore: 3 },
     { round: 29, home: "Sabah FC ", away: "Danger FC", homeScore: 0, awayScore: 3,forfeit: true },
     //Matchday 30
...
const REGULATIONS = [
  {
    ...
    body: "These are the rules and regulations set by Don Infantino: <br>Smart Assist: OFF.  <br>Both home and away legs to be played back 2 back.  <br> Match settings: Both teams set to Excellent Conditions before match. <br>IF NOT, match will be restarted set to correct conditions. <br>Max Subs and Intervals.   <br>Match Duration:10 minutes, Match Times: Matchdays will have dates from the second season above fixtures with the time limit as to allow for the table updates to occur during downtime.   <br>Friendlies are allowed after league matches period or before."
  },
  {
  ...
  },
  {
    ...
    body: "Season 1: contested by the top 2 in the Division 1 table.<br>From Season 2: contested by the League champion vs Champions Cup winner.<br>In the case of the league winner being the winner of the 2 competitions. 2nd place in the League will automatically be in the cup.<br> Cup is contested in one match set to extra time and penalties"
  },
  {
